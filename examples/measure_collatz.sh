...
make collatz.o0.bin >/dev/null 2>&1
...
echo "running collatz.o0.bin (by compilium)..."
( time ./collatz.o0.bin | tee collatz.o0.stdout.txt ) 2>&1 | grep real
...
diff -u collatz.stdout.txt collatz.o0.stdout.txt || { echo "stdout diff"; false; }
